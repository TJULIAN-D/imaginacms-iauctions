...
@section('content-header')
    <h1>
        {{ trans('iauctions::ingredients.title.edit ingredient') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.iauctions.ingredient.index') }}">{{ trans('iauctions::ingredients.title.ingredients') }}</a></li>
        <li class="active">{{ trans('iauctions::ingredients.title.edit ingredient') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.iauctions.ingredient.update', $ingredient->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <div class="tab-content">
                    @include('iauctions::admin.ingredients.partials.edit-fields')
