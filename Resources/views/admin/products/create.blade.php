...
@section('content-header')
    <h1>
        {{ trans('iauctions::products.title.create product') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.iauctions.product.index') }}">{{ trans('iauctions::products.title.products') }}</a></li>
        <li class="active">{{ trans('iauctions::products.title.create product') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.iauctions.product.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
            
            <div class="nav-tabs-custom">
                <div class="tab-content">
                    @include('iauctions::admin.products.partials.create-fields')
